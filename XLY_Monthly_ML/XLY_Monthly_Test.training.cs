...
namespace XLY_Monthly_ML
{
    public partial class Test
    {
        public const string RetrainFilePath =  @"C:\Users\Josh E\Desktop\Data to train on\monthly_XLY.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"open", @"open"),new InputOutputColumnPair(@"high", @"high"),new InputOutputColumnPair(@"low", @"low"),new InputOutputColumnPair(@"volume", @"volume")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=6,MinimumExampleCountPerLeaf=3,NumberOfTrees=17262,MaximumBinCountPerFeature=491,FeatureFraction=0.836871249155755,LearningRate=0.0010036789947992946,LabelColumnName=@"close",FeatureColumnName=@"Features",DiskTranspose=false}));
