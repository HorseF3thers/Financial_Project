    ...
    public partial class Test
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"open", @"open"),new InputOutputColumnPair(@"high", @"high"),new InputOutputColumnPair(@"low", @"low"),new InputOutputColumnPair(@"volume", @"volume")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=3301,NumberOfIterations=2389,MinimumExampleCountPerLeaf=20,LearningRate=0.018455484766306617,LabelColumnName=@"close",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.2876538649409948,FeatureFraction=0.9709292917622439,L1Regularization=2.792217286920767E-10,L2Regularization=0.6206600731198844},MaximumBinCountPerFeature=292}));
