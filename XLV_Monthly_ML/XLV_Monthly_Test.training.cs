...
namespace XLV_Monthly_ML
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Josh E\Desktop\Data to train on\monthly_XLV.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"open", @"open"),new InputOutputColumnPair(@"high", @"high"),new InputOutputColumnPair(@"low", @"low"),new InputOutputColumnPair(@"volume", @"volume")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=5,MinimumExampleCountPerLeaf=2,NumberOfTrees=118,MaximumBinCountPerFeature=158,FeatureFraction=0.9736157468971178,LearningRate=0.06686936479705384,LabelColumnName=@"close",FeatureColumnName=@"Features",DiskTranspose=false}));
