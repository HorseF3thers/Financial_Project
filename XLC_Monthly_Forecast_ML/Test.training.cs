...
namespace XLC_Monthly_Forecast_ML
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Josh E\Documents\ETF_forecast_portfolio\Data Before Feb\monthly_XLC.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:2,seriesLength:10,trainSize:80,horizon:5,outputColumnName:@"close",inputColumnName:@"close",confidenceLowerBoundColumn:@"close_LB",confidenceUpperBoundColumn:@"close_UB");
